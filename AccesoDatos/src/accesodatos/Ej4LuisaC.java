		...
		try (BufferedReader br = new BufferedReader(new FileReader(archivo))) {
			...
			while ((linea = br.readLine()) != null) {
				...
				for (int i = 0; i < linea.length(); i++) {
					...
					palabra = palabra + l;
					;
					// aumentamos el contador en cada vuelta para que cuando llegue a 5 inserte un
					// salto de linea
					contador++;
			...
			// Hacemos un split de la palabra que escribimos en el fichero, cortamos por los
			// saltos de linea
			...
			// Recorremos el array y en cada iteracion, que equivale en este caso a una
			// palabra
			// Escribimos la palabra en el fichero junto con un \n para que muestre cada
			// palabra en una linea
